...
async def search(req: SearchRequest):
    ...
    try:
        ...
        # Use higher limit internally to ensure we get enough results after filtering
        search_limit = req.limit * 2 if req.score_threshold else req.limit
        ...
        results = client.query_points(
            ...
            limit=search_limit,
            with_payload=True,
            score_threshold=req.score_threshold  # Apply score threshold if provided
        ).points
